...
import com.example.eatall.adapter.FoodListAdapter;
import com.example.eatall.db.DatabaseHelper;
import com.example.eatall.model.PhoneItem;
...
import static com.example.eatall.db.DatabaseHelper.COL_IMAGE;
import static com.example.eatall.db.DatabaseHelper.COL_TIME;
                ...
                new AlertDialog.Builder(MainActivity.this)
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                final PhoneItem item = mPhoneItemList.get(position);

                                switch (i) {
                                    case 0: // Edit
                                        Intent intent = new Intent(MainActivity.this, EditFoodItemActivity.class);
                                        intent.putExtra("title", item.title);
                                        intent.putExtra("cal", item.cal);
                                        intent.putExtra("time", item.time);
                                        intent.putExtra("image", item.image);
